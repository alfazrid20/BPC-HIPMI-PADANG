          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                    <a class="nav-link" href="/tambah-visimisi">Visi Misi</a>
                  </li>
                <li class="nav-item">
                  <a class="nav-link" href="/data-berita">Berita</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/data-kategori">Kategori Berita</a>
                  </li>
                <li class="nav-item">
                  <a class="nav-link" href="/tambah-about">About</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/data-struktur">Struktur</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/data-contact">Contact</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="/data-slider">Slider</a>
                  </li>
              </ul>
            </div>
          </li>
              ...
              <li class="nav-item nav-profile dropdown d-none d-md-block">
                ...
                <div class="dropdown-menu center navbar-dropdown" aria-labelledby="profileDropdown">
                  <a class="dropdown-item" href="#">
                    <i class="flag-icon flag-icon-id mr-3"></i> Indonesia </a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="#">
            ...
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                  <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> - developed by
                    <b><a href="https://indrijunanda.gitlab.io/" target="_blank">Alfazri Darmawansyah</a></b>
                  </span>
                </div>
              </div>
